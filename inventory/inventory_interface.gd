...
@onready var rod_inventory: PanelContainer = $RodInventory
...
func set_rod_inventory_data(inventory_data: InventoryData) -> void:
	inventory_data.inventory_interact.connect(on_inventory_interact)
	rod_inventory.set_inventory_data(inventory_data)
